...
let FilmService = class FilmService {
    ...
    getFilm() {
        return this.http.get('https://api.themoviedb.org/3/discover/movie?api_key=87dfa1c669eea853da609d4968d294be&language=en-US&sort_by=popularity.desc&page=5')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => data));
    }
    getFilmByName(name) {
        return this.http.get('https://api.themoviedb.org/3/movie/' + name + '?api_key=87dfa1c669eea853da609d4968d294be&language=en-US')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => data));
    }
};
...
let SearchService = class SearchService {
    ...
    getResult(name) {
        return this.http.get('https://api.themoviedb.org/3/search/multi?api_key=87dfa1c669eea853da609d4968d294be&language=en-US&query=' + name + '&include_adult=true')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => data));
    }
};
...
let SerieService = class SerieService {
    ...
    getSerieByName(name) {
        return this.http.get('https://api.themoviedb.org/3/tv/' + name + '?api_key=87dfa1c669eea853da609d4968d294be&language=en-US')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(data => data));
    }
};
...
let TrendingService = class TrendingService {
    ...
    getNowPlaying() {
        return this.http.get('https://api.themoviedb.org/3/movie/now_playing?api_key=87dfa1c669eea853da609d4968d294be&language=en-US&page=1')
